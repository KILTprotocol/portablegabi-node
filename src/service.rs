...
use log::info;
use node_portablegabi_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
...
native_executor_instance!(
	...
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/node_portablegabi_runtime_wasm.compact.wasm")
);
