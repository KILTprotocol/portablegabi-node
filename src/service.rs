...
use portablegabi_node_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
...
native_executor_instance!(
    ...
    include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/portablegabi_node_runtime_wasm.compact.wasm")
);
